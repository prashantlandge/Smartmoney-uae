        ...
        return [
            ScrapedProduct(
                ...
                key_features={
                    ...
                    "card_tier": "Platinum",
                    "best_for": "Cashback on dining & entertainment",
                    "contactless": True,
                    "apple_pay": True,
            ...
            ScrapedProduct(
                provider_id=self.PROVIDER_ID,
                category="credit_card",
                name_en="Emirates NBD Skywards Infinite Credit Card",
                name_ar="بطاقة الإمارات دبي الوطني سكاي واردز إنفينيت",
                description_en="Earn Emirates Skywards miles on every purchase. Unlimited airport lounge access worldwide.",
                ...
                affiliate_deep_link_en="https://emiratesnbd.com/cards/skywards-infinite?utm_source=smartmoney",
        ...
        return [
            ScrapedProduct(
                ...
                key_features={
                    ...
                    "best_for": "Salary transfer customers",
                },
            ...
            ScrapedProduct(
                provider_id=self.PROVIDER_ID,
                category="personal_loan",
                name_en="Emirates NBD Flexi Loan",
                name_ar="قرض مرن من الإمارات دبي الوطني",
                description_en="Flexible personal loan without salary transfer requirement. Competitive rates for non-salary transfer customers.",
                description_ar="قرض شخصي مرن بدون تحويل الراتب.",
                min_salary_aed=8000,
                ...
                affiliate_deep_link_en="https://emiratesnbd.com/loans/flexi?utm_source=smartmoney",
